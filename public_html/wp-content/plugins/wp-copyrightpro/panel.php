...
<input name="copy_link" id="copy_link" type="checkbox" disabled="disabled" value="y" <?php if ($copylink=="y"){?>checked<?php }?> />Places a message in your blog's footer<br>
<input type="submit" name="button" id="button_link" value="Update Options" disabled="disabled" class="button-secundary" />
</form>
</div>
</div>
<!-- Fin Menu link-->

...
<li class="comment">
 <div class="trackback_time">
  <?php echo get_comment_time(__('F jS, Y', 'neutral')) ?>
...
<p><?php printf(__('Logged in as <a href="%1$s">%2$s</a>.', 'neutral'), get_option('siteurl') . '/wp-admin/profile.php', $user_identity); ?><span><a href="<?php echo wp_logout_url(get_permalink()); ?>" title="<?php _e('Log out of this account', 'neutral'); ?>"><?php _e('[ Log out ]', 'neutral'); ?></a></span></p>
<?php } else { ?>
<p><?php printf(__('Logged in as <a href="%1$s">%2$s</a>.', 'neutral'), get_option('siteurl') . '/wp-admin/profile.php', $user_identity); ?><span><a href="<?php echo get_option('siteurl'); ?>/wp-login.php?action=logout" title="<?php _e('Log out of this account', 'neutral'); ?>"><?php _e('Log out', 'neutral'); ?></a></span></p>
<?php } ?>
